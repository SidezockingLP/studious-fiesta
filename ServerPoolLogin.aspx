<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ServerPoolLogin.aspx.vb" Inherits="Internetseite_Side_Dev.ServerPoolLogin" %>
...
<body>
        ...
        <h2>
            Login</h2>
        <p class="lead">
           Email:      <asp:TextBox runat="server" CssClass="auto-style4"></asp:TextBox>

        </p
              <p class="lead">
           Passwort: <asp:TextBox runat="server" Height="29px" Width="180px"></asp:TextBox>

        </p>
                <p class="lead">
          <asp:Button runat="server" Text="Einloggen"></asp:Button>
     ...
     <div class="clients-area center wow fadeInDown">
        ...
        <p class="lead">
           &nbsp;</p
              <p class="lead">
           Nickname: <asp:TextBox runat="server" Height="29px" Width="180px"></asp:TextBox>

        </p
                <p class="lead">
           Email: <asp:TextBox runat="server" Height="29px" Width="180px"></asp:TextBox>
           ...
           Passwort: <asp:TextBox runat="server" Height="29px" Width="180px"></asp:TextBox>
                ...
                <p class="lead">
           PasswortWdh: <asp:TextBox runat="server" Height="29px" Width="180px"></asp:TextBox>

        </p>
                <p class="lead">
          <asp:Button runat="server" Text="regestrieren"></asp:Button>
